...
void read_wav_header(FILE * ptr, struct wav_header& header, bool verbose) {
  // Buffers used to to big endian conversion 
...
void compute_wave_sample_sizes(FILE * ptr, struct wav_header& header, long& num_samples, long& size_of_each_sample) {
...
void read_pcm_wav_data(FILE * ptr, struct wav_header& header, long num_samples, long size_of_each_sample, std::vector<Cpx<double>> &out) {
